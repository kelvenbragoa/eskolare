...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">{{__('text.assets')}}</h1>

    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('text.assets')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('assets.store')}}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" name="identifier" id="identifier" placeholder="{{__('text.identifier')}}" value="{{ old('identifier') }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" name="type" id="type" placeholder="{{__('text.type')}}" value="{{ old('type') }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" id="attributes" name="attributes" placeholder="{{__('text.atributes')}}" value="{{ old('attributes') }}" required>
                            </div>

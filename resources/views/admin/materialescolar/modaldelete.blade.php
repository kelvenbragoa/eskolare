    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Deseja apagar este registro? <br>"{{$item->material->name}}"</h5>
        ...
        <div class="modal-footer">
            <form method="POST" action="{{ route('materialescolar.destroy', $item->id)}}">
                @csrf
                @method('DELETE')
